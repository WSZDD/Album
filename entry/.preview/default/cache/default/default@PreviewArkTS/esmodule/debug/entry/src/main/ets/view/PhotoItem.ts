...
export default class PhotoItem extends ViewPU {
    ...
    albumPicBuilder(img: Resource, index: number, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/PhotoItem.ets(30:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(img);
            Image.debugLine("entry/src/main/ets/view/PhotoItem.ets(31:7)", "entry");
            Image.width(Constants.FULL_PERCENT);
            Image.height(Constants.FULL_PERCENT);
            Image.borderRadius({ "id": 16777221, "type": 10002, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/view/PhotoItem.ets(46:5)", "entry");
...
if (getPreviewComponentFlag()) {
    storePreviewComponents(1, "PhotoItem", new PhotoItem(undefined, {}));
    previewComponent();
}
else {
}
