...
class DetailPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/DetailPage.ets(68:5)", "entry");
            Stack.offset({ x: -(this.smallImgWidth / Constants.DOUBLE_NUMBER) });
            Stack.width(this.imageWidth);
            Stack.height(Constants.FULL_PERCENT);
            Stack.backgroundColor({ "id": 16777240, "type": 10001, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" });
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create({ scroller: this.scroller, initialIndex: this.selectedIndex });
            List.debugLine("entry/src/main/ets/pages/DetailPage.ets(69:7)", "entry");
            List.onScrollStop(() => {
            ...
            const forEachItemGenFunction = _item => {
                const img = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/pages/DetailPage.ets(71:11)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Image.create(img);
                            Image.debugLine("entry/src/main/ets/pages/DetailPage.ets(72:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/DetailPage.ets(127:7)", "entry");
            Gesture.create(GesturePriority.Low);
            GestureGroup.create(GestureMode.Exclusive);
            PinchGesture.create({ fingers: Constants.DOUBLE_NUMBER });
            PinchGesture.onActionUpdate((event?: GestureEvent) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.photoArr[this.selectedIndex]);
            Image.debugLine("entry/src/main/ets/pages/DetailPage.ets(128:9)", "entry");
            Image.position({ x: this.imgOffSetX, y: this.imgOffSetY });
...
registerNamedRoute(() => new DetailPage(undefined, {}), "", { bundleName: "com.example.electronicalbum", moduleName: "entry", pagePath: "pages/DetailPage", pageFullPath: "entry/src/main/ets/pages/DetailPage", integratedHsp: "false" });
