...
interface DetailListPage_Params {
    ...
    imageWidth?: number;
    photoArr?: Array<Resource | string>;
    smallPhotoArr?: Array<Resource | string>;
...
class DetailListPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.photoArr = (router.getParams() as Record<string, Array<Resource | string>>)[`${Constants.PARAM_PHOTO_ARR_KEY}`];
        this.smallPhotoArr = new Array<Resource | string>().concat(Constants.CACHE_IMG_LIST, (router.getParams() as Record<string, Array<Resource | string>>)[`${Constants.PARAM_PHOTO_ARR_KEY}`], Constants.CACHE_IMG_LIST);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (index && index > (Constants.CACHE_IMG_SIZE - 1) && index < (this.smallPhotoArr.length - Constants.CACHE_IMG_SIZE)) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create(img);
                        Image.debugLine("entry/src/main/ets/pages/DetailListPage.ets(41:7)", "entry");
                        Image.onClick(() => this.smallImgClickAction(index));
                    }, Image);
                });
            }
            else {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/DetailListPage.ets(94:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/pages/DetailListPage.ets(95:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/pages/DetailListPage.ets(96:9)", "entry");
            ...
            const forEachItemGenFunction = _item => {
                const img = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/pages/DetailListPage.ets(98:13)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Image.create(img);
                            Image.debugLine("entry/src/main/ets/pages/DetailListPage.ets(99:15)", "entry");
                            ...
                            PinchGesture.pop();
                            Gesture.pop();
                            Image.onClick(() => this.goDetailPage());
                        }, Image);
                        ListItem.pop();
                    };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            List.debugLine("entry/src/main/ets/pages/DetailListPage.ets(126:9)", "entry");
            List.listDirection(Axis.Horizontal);
            List.onScroll((scrollOffset, scrollState) => {
                if (scrollState === ScrollState.Fling) {
            ...
            List.margin({ top: { "id": 16777219, "type": 10002, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" }, bottom: { "id": 16777219, "type": 10002, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" } });
            ...
            const forEachItemGenFunction = (_item, index?: number) => {
                const img = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/pages/DetailListPage.ets(132:13)", "entry");
                    };
                    const deepRenderFunction = (elmtId, isInitialRender) => {
                        itemCreation(elmtId, isInitialRender);
                        this.SmallImgItemBuilder.bind(this)(img, index, this);
                        ListItem.pop();
                    };
                    this.observeComponentCreation2(itemCreation2, ListItem);
                    ListItem.pop();
...
registerNamedRoute(() => new DetailListPage(undefined, {}), "", { bundleName: "com.example.electronicalbum", moduleName: "entry", pagePath: "pages/DetailListPage", pageFullPath: "entry/src/main/ets/pages/DetailListPage", integratedHsp: "false" });
