...
class ListPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/ListPage.ets(26:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Grid.create();
            Grid.debugLine("entry/src/main/ets/pages/ListPage.ets(27:7)", "entry");
            ...
            const forEachItemGenFunction = (_item, index?: number) => {
                const img = _item;
                {
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        GridItem.debugLine("entry/src/main/ets/pages/ListPage.ets(29:11)", "entry");
                    };
                    const observedDeepRender = () => {
                        this.observeComponentCreation2(itemCreation2, GridItem);
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Image.create(img);
                            Image.debugLine("entry/src/main/ets/pages/ListPage.ets(30:13)", "entry");
