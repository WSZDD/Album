...
export class TipsUtil extends ViewPU {
        ...
        this.dialogControllerProgress = new CustomDialogController({
            builder: () => {
                let jsDialog = new TipsDialog(this, {
                    ...
                    imageRes: { "id": 16777249, "type": 20000, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" },
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/TipsUtil.ets(113:5)", "@yunkss/ef_ui");
        }, Row);
        Row.pop();
    }
    rerender() {
