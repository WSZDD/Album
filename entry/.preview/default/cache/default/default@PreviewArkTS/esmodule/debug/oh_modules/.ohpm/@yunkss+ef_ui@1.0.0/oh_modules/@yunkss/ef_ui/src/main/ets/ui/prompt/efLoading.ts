...
class efAlert extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(41:5)", "@yunkss/ef_ui");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(42:7)", "@yunkss/ef_ui");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.options.imgLayout != undefined && this.options.imgLayout === ImgLayout.TOP) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(44:11)", "@yunkss/ef_ui");
                        Column.width(this.options.layoutShape != undefined && this.options.layoutShape === LoadingShape.RECTANGLE ? '100%' :
                            '50%');
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777248, "type": 20000, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" });
                        Image.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(45:13)", "@yunkss/ef_ui");
                        Context.animation({
                            duration: 50,
                            curve: Curve.Linear,
                            iterations: 1,
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(61:13)", "@yunkss/ef_ui");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.options.imgLayout != undefined && this.options.imgLayout === ImgLayout.BOTTOM) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(69:11)", "@yunkss/ef_ui");
                        Column.width(this.options.layoutShape != undefined && this.options.layoutShape === LoadingShape.RECTANGLE ? '100%' :
                            '50%');
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(this.options.content);
                        Text.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(70:13)", "@yunkss/ef_ui");
                        __Text__loadingTxt(this.options.fontSize ? this.options.fontSize : UiConst.FONT_16);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777248, "type": 20000, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" });
                        Image.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(73:13)", "@yunkss/ef_ui");
                        Context.animation({
                            duration: 50,
                            curve: Curve.Linear,
                            iterations: 1,
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.options.imgLayout != undefined && this.options.imgLayout === ImgLayout.RIGHT) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(94:11)", "@yunkss/ef_ui");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(this.options.content);
                        Text.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(95:13)", "@yunkss/ef_ui");
                        __Text__loadingTxt(this.options.fontSize ? this.options.fontSize : UiConst.FONT_16);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777248, "type": 20000, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" });
                        Image.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(97:13)", "@yunkss/ef_ui");
                        Context.animation({
                            duration: 50,
                            curve: Curve.Linear,
                            iterations: 1,
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.options.imgLayout != undefined && this.options.imgLayout === ImgLayout.LEFT) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(120:11)", "@yunkss/ef_ui");
                        Row.width(this.options.layoutShape != undefined && this.options.layoutShape === LoadingShape.RECTANGLE ? '100%' :
                            '50%');
                        Row.alignItems(VerticalAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777248, "type": 20000, params: [], "bundleName": "com.example.electronicalbum", "moduleName": "entry" });
                        Image.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(121:13)", "@yunkss/ef_ui");
                        Context.animation({
                            duration: 50,
                            curve: Curve.Linear,
                            iterations: 1,
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(this.options.content);
                        Text.debugLine("oh_modules/.ohpm/@yunkss+ef_ui@1.0.0/oh_modules/@yunkss/ef_ui/src/main/ets/ui/prompt/efLoading.ets(137:13)", "@yunkss/ef_ui");
                        __Text__loadingTxt(this.options.fontSize ? this.options.fontSize : UiConst.FONT_16);
